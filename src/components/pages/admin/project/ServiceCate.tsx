...
const ServiceCateCard: React.FC<CategoryCardProps> = ({ onCategorySelect }) => {
  const { services, isLoading, isError } = ServiceList(1, { limit: 20 }, 0);
...
export default ServiceCateCard;
